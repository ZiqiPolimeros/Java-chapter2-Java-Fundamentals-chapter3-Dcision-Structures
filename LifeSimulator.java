...
public class LifeSimulator {
	...
	//ASK FOR USER INPUT
        ...
        System.out.println("Welcome to the Life Simulator!\n" +
                "Life Simulator can predict your future base on you current condition.\n" +
                "Give it a try and answer the following questions.\n" +
                "What's your name?");
        name = s.nextLine();
        System.out.println("What's your job?");
        wantsThisJob = s.nextLine();
        System.out.println("Do you want to get married?");
        wantsToMarry = s.nextLine();
        System.out.println("Do you want children?");
